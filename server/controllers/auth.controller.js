...
export const login = async (req, res) => {
    ...
    try {
        ...
        //.populate("roleId") replaces the roleId field in the User document with the full document it references
        ...
        //generates a signed JWT as an access token for the user. The token contains the user’s ID,
        // which can be used to identify the user in subsequent requests
        //{ id: existingUser._id } is the payload, process.env.SECRET_KEY is the secret key used to sign the token,
        // and { expiresIn: process.env.JWT_TOKEN_EXPIRATION } is the expiration time of the token
