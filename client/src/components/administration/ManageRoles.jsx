//Necessary components and hooks are imported from Chakra UI, React, custom services, and utility files.
...
const ManageRoles = () => {
  ...
  return (
    <>
      ...
      <Table //allRolesSWR: Fetches and caches roles data using the useApi hook
      ...
      <CreateRole
        ...
        //viewRole: State to track the role that the user is currently viewing or editing.
